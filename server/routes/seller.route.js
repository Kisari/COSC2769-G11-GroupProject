...
sellerRouter.put('/api/v1/seller/:id/approved', requireAuth, sellerController.approveSeller);
sellerRouter.put('/api/v1/seller/:id/rejected', requireAuth, sellerController.rejectSeller);